...
export default function SlipGajiView() {
  ...
  const slipData = useMemo(() => {
    ...
    // In Slip Salary, we might want to see even PAID entries for historical view,
    // but the calculateUpah in store currently filters only UNPAID.
    // For a real slip, we'd need a separate "getPaidEntries" call.
    // Let's assume for this dummy we view what's currently in the rekap range.
